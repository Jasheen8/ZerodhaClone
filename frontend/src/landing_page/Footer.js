      ...
      <div className="container mt-5 ">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <br />
            <a href="" className=" text-muted" style={{textDecoration:"none"}}>Status of your complaint?</a>
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            Zerodha Broking Ltd.: Me of NSE, BSE​ &​ MCX – SEBI Registration
          ...
          <p>
            ...
            w.e.f Septe 01, 2020. 2) Update your e-mail and phone nu
            with your stock broker / depository participant and receive OTP
            directly from depository on your e-mail and/or mobile nu to
          ...
          <p>
            ...
            mobile nus/email IDs with your stock brokers. Receive
            ...
            issue a cheque. Please write the Bank account nu and sign the
